      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-light tracking-wider mb-4">
            <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">ALGOFLOW</span>
          </h1>
          <div className="text-xl md:text-2xl font-light tracking-[0.3em] text-gray-300 mb-12">SYSTEMS</div>
